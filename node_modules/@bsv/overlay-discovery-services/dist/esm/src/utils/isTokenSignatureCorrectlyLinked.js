 ...
 */
export const isTokenSignatureCorrectlyLinked = async (lockingPublicKey, fields) => {
    ...
    const protocolID = [2, Utils.toUTF8(fields[0]) === 'SHIP' ? 'service host interconnect' : 'service lookup availability'];
