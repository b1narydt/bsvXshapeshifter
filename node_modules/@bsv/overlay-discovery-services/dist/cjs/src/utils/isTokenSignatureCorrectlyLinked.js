...
exports.isTokenSignatureCorrectlyLinked = void 0;
 ...
 */
const isTokenSignatureCorrectlyLinked = async (lockingPublicKey, fields) => {
    ...
    const protocolID = [2, sdk_1.Utils.toUTF8(fields[0]) === 'SHIP' ? 'service host interconnect' : 'service lookup availability'];
    // The identity key is in the second field
    const identityKey = sdk_1.Utils.toHex(fields[1]);
...
exports.isTokenSignatureCorrectlyLinked = isTokenSignatureCorrectlyLinked;
//# sourceMappingURL=isTokenSignatureCorrectlyLinked.js.map