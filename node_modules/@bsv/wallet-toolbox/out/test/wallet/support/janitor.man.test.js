...
const localWallet_man_test_1 = require("../local/localWallet.man.test");
describe('janitor tests', () => {
    ...
    test('0 review utxos by identity key', async () => {
        ...
        const { invalidSpendableOutputs: notUtxos } = await (0, localWallet_man_test_1.confirmSpendableOutputs)(storage, services, identityKey);
