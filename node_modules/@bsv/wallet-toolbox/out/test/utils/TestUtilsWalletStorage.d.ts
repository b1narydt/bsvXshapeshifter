import { Beef, CreateActionResult, HexString, KeyDeriver, PrivateKey, PublicKey, SignActionResult, Transaction, WalletAction, WalletActionInput, WalletActionOutput, WalletCertificate, WalletInterface } from '@bsv/sdk';
import { sdk, StorageProvider, StorageKnex, Wallet, Monitor, Services, WalletStorageManager, TableOutputBasket, TableOutput, TableMonitorEvent, TableProvenTxReq, TableProvenTx, TableCommission, TableTransaction, TableTxLabelMap, TableTxLabel, TableUser, TableSyncState, TableCertificate, TableCertificateField, TableOutputTagMap, TableOutputTag } from '../../src/index.all';
...
export declare abstract class TestUtilsWalletStorage {
     ...
     */
    static createTestWallet(args: sdk.Chain | CreateTestWalletArgs): Promise<TestWalletNoSetup>;
    ...
    static insertTestProvenTx(storage: StorageProvider, txid?: string): Promise<TableProvenTx>;
    ...
    static createWalletSetupEnv(chain: sdk.Chain): Promise<TestWalletOnly>;
    /**
     ...
     */
    static createNoSendTxPair(wallet: Wallet | sdk.Chain, satoshis?: number): Promise<{
        txidDo: string;
        txidUndo: string;
        beef: Beef;
