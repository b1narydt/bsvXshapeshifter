...
describe('TxLabel Class Tests', () => {
    ...
    beforeAll(async () => {
        ...
        if (env.runMySQL) {
            ctxs.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletMySQLCopy('txLabelTests_db1'));
            ctxs2.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletMySQLCopy('txLabelTests_db2'));
        }
        ctxs.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletSQLiteCopy('txLabelTests_db1'));
        ctxs2.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletSQLiteCopy('txLabelTests_db2'));
    });
    afterAll(async () => {
    ...
    test('1_creates_txLabel_with_default_values', () => {
        const txLabel = new TxLabel_1.EntityTxLabel();
        // Default values
    ...
    test('2_creates_txLabel_with_provided_api_object', () => {
        ...
        const txLabel = new TxLabel_1.EntityTxLabel(apiObject);
    ...
    test('5_mergeExisting_does_not_update_txLabel_when_ei_updated_at_is_older', async () => {
        for (const { activeStorage } of ctxs) {
            ...
            const result = await txLabel.mergeExisting(activeStorage, undefined, olderEi, {});
            const reloadedTxLabel = await activeStorage.findTxLabelById(txLabel.id);
            expect(result).toBe(false);
            expect(reloadedTxLabel === null || reloadedTxLabel === void 0 ? void 0 : reloadedTxLabel.label).toBe('Original Label');
            expect(reloadedTxLabel === null || reloadedTxLabel === void 0 ? void 0 : reloadedTxLabel.isDeleted).toBe(false);
            expect(reloadedTxLabel === null || reloadedTxLabel === void 0 ? void 0 : reloadedTxLabel.updated_at).toEqual(new Date('2023-02-01'));
        }
    });
...
//# sourceMappingURL=TxLabelTests.test.js.map