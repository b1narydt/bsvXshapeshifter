...
import { sdk, TableOutput, TableTransaction } from '../../../index.client';
...
export declare class EntityTransaction extends EntityBase<TableTransaction> {
     ...
     */
    getInputs(storage: EntityStorage, trx?: sdk.TrxToken): Promise<TableOutput[]>;
    ...
    get status(): sdk.TransactionStatus;
    ...
    static mergeFind(storage: EntityStorage, userId: number, ei: TableTransaction, syncMap: SyncMap, trx?: sdk.TrxToken): Promise<{
        found: boolean;
        eo: EntityTransaction;
        eiId: number;
    }>;
    mergeNew(storage: EntityStorage, userId: number, syncMap: SyncMap, trx?: sdk.TrxToken): Promise<void>;
    mergeExisting(storage: EntityStorage, since: Date | undefined, ei: TableTransaction, syncMap: SyncMap, trx?: sdk.TrxToken): Promise<boolean>;
    getProvenTx(storage: EntityStorage, trx?: sdk.TrxToken): Promise<EntityProvenTx | undefined>;
}
