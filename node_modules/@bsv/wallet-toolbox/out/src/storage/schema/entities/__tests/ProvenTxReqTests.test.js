...
const ProvenTxReq_1 = require("../../../../../src/storage/schema/entities/ProvenTxReq");
describe('ProvenTxReq class method tests', () => {
    ...
    test('0_apiNotify_getter_and_setter', () => {
        const provenTxReq = new ProvenTxReq_1.EntityProvenTxReq({
            provenTxReqId: 0,
            created_at: new Date(),
            updated_at: new Date(),
            txid: '',
    ...
    test('5_equals_identifies_matching_entities', async () => {
        ...
        const provenTxReq1 = new ProvenTxReq_1.EntityProvenTxReq({
            provenTxReqId: 405,
        ...
        const provenTxReq2 = new ProvenTxReq_1.EntityProvenTxReq({
            provenTxReqId: 406,
            created_at: currentTime,
            updated_at: currentTime,
            txid: 'test-equals',
    ...
    test('12_isTerminalStatus_with_real_data', async () => {
        ...
        for (const { status, expected } of testCases) {
            expect(ProvenTxReq_1.EntityProvenTxReq.isTerminalStatus(status)).toBe(expected);
        }
    });
