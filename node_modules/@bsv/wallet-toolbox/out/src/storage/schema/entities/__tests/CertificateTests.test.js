...
const Certificate_1 = require("../../../../../src/storage/schema/entities/Certificate");
describe('Certificate class method tests', () => {
    ...
    test('0_equals identifies matching Certificate entities', async () => {
        for (const { activeStorage } of ctxs) {
            ...
            const entity1 = new Certificate_1.EntityCertificate(certificateData);
            const entity2 = new Certificate_1.EntityCertificate(certificateData);
    ...
    test('1_equals identifies non-matching Certificate entities', async () => {
        for (const { activeStorage } of ctxs) {
            ...
            const entity1 = new Certificate_1.EntityCertificate(certificateData1);
            const entity2 = new Certificate_1.EntityCertificate(certificateData2);
            ...
            for (const mismatch of mismatchedEntities) {
                const mismatchedEntity = new Certificate_1.EntityCertificate({
                    ...certificateData1,
                    ...mismatch
                });
    ...
    test('2_mergeExisting updates entity and database when ei.updated_at > this.updated_at', async () => {
        for (const { activeStorage } of ctxs) {
            ...
            const entity = new Certificate_1.EntityCertificate(certificateData);
    ...
    test('4_Certificate class getters and setters', async () => {
        for (const { activeStorage } of ctxs) {
            ...
            const entity = new Certificate_1.EntityCertificate(initialData);
            // Validate getters
