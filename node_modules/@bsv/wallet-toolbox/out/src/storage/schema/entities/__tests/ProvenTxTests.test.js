...
const ProvenTx_1 = require("../../../../../src/storage/schema/entities/ProvenTx");
describe('ProvenTx class method tests', () => {
    ...
    test('0_fromTxid: valid txid with rawTx and Merkle proof (real database)', async () => {
        ...
        const result = await ProvenTx_1.EntityProvenTx.fromTxid(txid, services);
    ...
    test('3_ProvenTx getters and setters', () => {
        ...
        const provenTx = new ProvenTx_1.EntityProvenTx(mockData);
        // Validate getters
    ...
    test('4_equals: identifies matching ProvenTx entities', async () => {
        ...
        const provenTx1 = new ProvenTx_1.EntityProvenTx({
            provenTxId: 401,
            txid: 'valid-txid',
        ...
        const provenTx2 = new ProvenTx_1.EntityProvenTx({
            provenTxId: 401,
            txid: 'valid-txid',
            created_at: new Date('2023-01-01'),
            updated_at: new Date('2023-01-02'),
    ...
    test('9_equals: provenTxId mismatch without syncMap', async () => {
        ...
        const tx1 = new ProvenTx_1.EntityProvenTx({
            provenTxId: 405,
            txid: 'txid1',
            created_at: new Date('2023-01-01'),
            updated_at: new Date('2023-01-02'),
        ...
        const tx2 = new ProvenTx_1.EntityProvenTx({
            provenTxId: 406,
            txid: 'txid1',
            created_at: new Date('2023-01-01'),
            updated_at: new Date('2023-01-02'),
    ...
    test('10_mergeExisting: always returns false', async () => {
        ...
        const provenTx = new ProvenTx_1.EntityProvenTx({
            provenTxId: 101,
            txid: 'txid1',
            created_at: new Date('2023-01-01'),
            updated_at: new Date('2023-01-02'),
