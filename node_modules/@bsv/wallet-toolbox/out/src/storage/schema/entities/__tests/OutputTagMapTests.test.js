...
const OutputTagMap_1 = require("../../../../../src/storage/schema/entities/OutputTagMap");
describe('OutputTagMap class method tests', () => {
    ...
    beforeAll(async () => {
        if (env.runMySQL) {
            ctxs.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletMySQLCopy('OutputTagMapTests'));
            ctxs2.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletMySQLCopy('OutputTagMapTests2'));
        }
        ctxs.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletSQLiteCopy('OutputTagMapTests'));
        ctxs2.push(await TestUtilsWalletStorage_1.TestUtilsWalletStorage.createLegacyWalletSQLiteCopy('OutputTagMapTests2'));
    });
    afterAll(async () => {
    ...
    test('0_OutputTagMap getters and setters', async () => {
        ...
        const outputTagMap = new OutputTagMap_1.EntityOutputTagMap(initialData);
        // Test getters
        ...
        expect(() => outputTagMap.id).toThrow(src_1.sdk.WERR_INVALID_OPERATION);
    });
    test('1_equals returns true for matching entities', async () => {
        ...
        const entity1 = new OutputTagMap_1.EntityOutputTagMap(outputTagMapData);
        const entity2 = new OutputTagMap_1.EntityOutputTagMap(outputTagMapData);
    ...
    test('2_equals returns false for non-matching entities', async () => {
        ...
        // Create entities from the records
        const entity1 = new OutputTagMap_1.EntityOutputTagMap(outputTagMapData1);
        const entity2 = new OutputTagMap_1.EntityOutputTagMap(outputTagMapData2);
        const syncMap = (0, src_1.createSyncMap)();
    ...
    test('3_mergeExisting merges and updates entity when ei.updated_at > this.updated_at', async () => {
        ...
        const entity = new OutputTagMap_1.EntityOutputTagMap(initialData);
...
//# sourceMappingURL=OutputTagMapTests.test.js.map