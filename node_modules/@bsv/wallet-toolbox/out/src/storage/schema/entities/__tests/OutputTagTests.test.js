...
const OutputTag_1 = require("../../../../../src/storage/schema/entities/OutputTag");
describe('OutputTag class method tests', () => {
    ...
    test('0_mergeExisting merges and updates entity when ei.updated_at > this.updated_at', async () => {
        ...
        const entity = new OutputTag_1.EntityOutputTag(initialData);
    ...
    test('2_equals identifies matching entities without syncMap', async () => {
        ...
        const entity1 = new OutputTag_1.EntityOutputTag(data);
        const entity2 = new OutputTag_1.EntityOutputTag(data);
    ...
    test('3_equals identifies non-matching entities when tags differ', async () => {
        ...
        // Create OutputTag entities
        const entity1 = new OutputTag_1.EntityOutputTag(data1);
        const entity2 = new OutputTag_1.EntityOutputTag(data2);
    ...
    test('7_getters and setters work as expected for OutputTag', () => {
        ...
        const outputTag = new OutputTag_1.EntityOutputTag();
