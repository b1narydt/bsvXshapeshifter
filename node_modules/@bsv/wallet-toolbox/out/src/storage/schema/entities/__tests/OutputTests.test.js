...
const Output_1 = require("../../../../../src/storage/schema/entities/Output");
describe('Output class method tests', () => {
    ...
    test('0_equals identifies matching entities with and without SyncMap', async () => {
        ...
        const entity1 = new Output_1.EntityOutput(initialData);
        const entity2 = new Output_1.EntityOutput(initialData);
    ...
    test('1_equals identifies non-matching entities', async () => {
        ...
        const entity1 = new Output_1.EntityOutput(initialData);
        const entity2 = new Output_1.EntityOutput({
            ...initialData,
            satoshis: 2000
        });
    ...
    test('3_mergeExisting updates entity and database when ei.updated_at > this.updated_at', async () => {
        ...
        const entity = new Output_1.EntityOutput(initialData);
