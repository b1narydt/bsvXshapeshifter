...
async function testChaintracksChaintracker(chain) {
    const tracker = new __1.ChaintracksChainTracker(chain);
...
//# sourceMappingURL=ChaintracksChainTracker.test.js.map