...
exports.default = (config = {}) => {
    const { faviconUrl = 'https://bsvblockchain.org/favicon.ico', backgroundColor = '#282E33', primaryColor = '#B6C2CF', secondaryColor = '#579DFF', fontFamily = 'Arial, sans-serif', headingFontFamily = 'Arial Black, Gadget, sans-serif', additionalStyles = '', sectionBackgroundColor = '#323940', linkColor = '#579DFF', hoverColor = '#3A4147', borderColor = '#B6C2CF', } = config;
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
...
//# sourceMappingURL=makeUserInterface.js.map